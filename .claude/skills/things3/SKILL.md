...
3. **Project backlinks are mandatory.** Every Things 3 project MUST have an Obsidian backlink in its notes field:
   ...
   ```
   When creating a project or encountering one without a backlink, add it via `update_project`. Also ensure the corresponding Obsidian project folder and note exist at `/Users/alexhedtke/Exobrain/Projects/[Project Name]/[Project Name].md`.
